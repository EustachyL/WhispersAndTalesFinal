package crc647699bb8c07bd6ef7;


public class AndroidPermissionChecker_ActivityLifecycleListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WhispersAndTales.AndroidPermissionChecker+ActivityLifecycleListener, WhispersAndTales", AndroidPermissionChecker_ActivityLifecycleListener.class, __md_methods);
	}


	public AndroidPermissionChecker_ActivityLifecycleListener ()
	{
		super ();
		if (getClass () == AndroidPermissionChecker_ActivityLifecycleListener.class) {
			mono.android.TypeManager.Activate ("WhispersAndTales.AndroidPermissionChecker+ActivityLifecycleListener, WhispersAndTales", "", this, new java.lang.Object[] {  });
		}
	}
