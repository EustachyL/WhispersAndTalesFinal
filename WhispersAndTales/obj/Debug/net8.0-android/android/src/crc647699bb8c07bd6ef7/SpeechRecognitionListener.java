...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WhispersAndTales.SpeechRecognitionListener, WhispersAndTales", SpeechRecognitionListener.class, __md_methods);
	}
	...
	public SpeechRecognitionListener ()
	{
		...
		if (getClass () == SpeechRecognitionListener.class) {
			mono.android.TypeManager.Activate ("WhispersAndTales.SpeechRecognitionListener, WhispersAndTales", "", this, new java.lang.Object[] {  });
		}
	}
